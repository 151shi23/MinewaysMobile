            ...
            public Optional<ChunkerItemDisplay> read(@NotNull CompoundTag value) {
                ...
                if (display != null) {
                    ...
                    if (display.contains("color")) {
                        color = ChunkerColor.fromRGB(display.getInt("color"));
                    }
                }
            ...
            public Optional<ChunkerFireworks> read(@NotNull CompoundTag value) {
                ...
                if (explosionsTag != null) {
                    ...
                    for (CompoundTag explosionTag : explosionsTag) {
                        ...
                        List<ChunkerColor> colors = colorsRGB == null ? Collections.emptyList() : IntStream.of(colorsRGB)
                                .mapToObj(ChunkerColor::new)
                                .toList();

                        // Parse fade colors
                        int[] fadeColorsRGB = explosionTag.getIntArray("FadeColors", null);
                        List<ChunkerColor> fadeColors = fadeColorsRGB == null ? Collections.emptyList() : IntStream.of(fadeColorsRGB)
                                .mapToObj(ChunkerColor::new)
                                .toList();
