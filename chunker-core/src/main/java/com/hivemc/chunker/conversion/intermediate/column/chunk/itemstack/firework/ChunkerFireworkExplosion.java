...
public class ChunkerFireworkExplosion {
    ...
    private List<ChunkerColor> colors;
    private List<ChunkerColor> fadeColors;
     ...
     */
    public ChunkerFireworkExplosion(ChunkerFireworkShape shape, List<ChunkerColor> colors, List<ChunkerColor> fadeColors, boolean trail, boolean twinkle) {
        this.shape = shape;
        this.colors = colors;
     ...
     */
    public List<ChunkerColor> getColors() {
        return colors;
    }
     ...
     */
    public void setColors(List<ChunkerColor> colors) {
        this.colors = colors;
    }
     ...
     * @return a list of the colors.
     */
    public List<ChunkerColor> getFadeColors() {
        return fadeColors;
    }
     ...
     */
    public void setFadeColors(List<ChunkerColor> fadeColors) {
        this.fadeColors = fadeColors;
    }
