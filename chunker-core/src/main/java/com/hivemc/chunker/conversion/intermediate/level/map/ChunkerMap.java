...
public class ChunkerMap {
     ...
     * <p>
     * Android port note: the original implementation decoded the file with {@code javax.imageio.ImageIO}
     * and resized it with {@code java.awt.image.BufferedImage} / {@code Graphics2D}. Android has neither
     * package, so both the decoding and the rescaling are unavailable here. This method is unused by the
     * converter itself (maps are carried as raw RGBA {@code bytes}), therefore it fails fast with a clear
     * exception instead of a {@code NoClassDefFoundError}. Re-add a platform decoder if it is ever needed.
     *
    ...
    public void loadImage(File file) throws IOException {
        ...
        throw new UnsupportedOperationException(
                "Image loading requires javax.imageio/java.awt, which Android does not provide");
    }
